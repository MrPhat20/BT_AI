...
def make_window(theme=None):
    ...
    window = sg.Window('Luu Tien Phat', layout, finalize=True, right_click_menu=sg.MENU_RIGHT_CLICK_EDITME_VER_EXIT, keep_on_top=True, use_custom_titlebar=use_custom_titlebar)
